...
root.iconbitmap(r'D:\currency_converter-main\currency_converter-main\curic.ico')



image = Image.open(r"D:\currency_converter-main\currency_converter-main\reverse.png")
...
# ==============================INR TO .......======================================
        ...
        if m.get()=="USD":
            e2.delete(0,END)
            e2.insert(0,str(round(int(e1.get())/73.98,3)))
        if m.get()=="AUSD":
            e2.delete(0,END)
            e2.insert(0,str(round(int(e1.get())*0.019,3)))
        if m.get()=="EURO":
            e2.delete(0,END)
